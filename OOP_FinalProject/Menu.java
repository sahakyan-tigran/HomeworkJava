import Service.DefenderService;
import Service.ForwardService;
import Service.GoalKeeperService;
...
public class Menu {
    ...
    public static void goalkeepersMenu() throws IOException {
        GoalKeeperService gks = new GoalKeeperService();
        boolean flag = true;
        while(flag){
    ...
    public static void defendersMenu() throws IOException {
        DefenderService dfs = new DefenderService();
        boolean flag = true;
        while(flag){
    ...
    public static void forwardsMenu() throws IOException {
        ForwardService fws = new ForwardService();
        boolean flag = true;
        while(flag){
